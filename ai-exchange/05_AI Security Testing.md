...
<tr>
	<td>人気</td>
	<td><ul><li>GitHub スター: 約 4,900 スター （2024 年現在）<li>GitHub フォーク: 約 1,200 フォーク<li>Issue 数: 761 件の解決済み、約 131 件の未解決<li>トレンド: 敵対的堅牢性のための継続的なアップデートと業界での採用により、着実に成長しています。</ul></td>
</tr>
<tr>
	<td>コミュニティ サポート</td>
...
<tr>
	<td>人気</td>
	<td><ul><li>GitHub スター: 約 176 スター （2024 年現在）<li>GitHub フォーク: 約 67 フォーク<li>Issue 数: 733 件の解決済み、約 59 件の未解決、26 人の貢献者<li>トレンド: 特に防衛およびサイバーセキュリティ分野で成長しています。</ul></td>
</tr>
<tr>
	<td>コミュニティ サポート</td>
...
<tr>
	<td>人気</td>
	<td><ul><li>GitHub スター: 約 2,800 スター （2024 年現在）<li>GitHub フォーク: 約 428 フォーク<li>Issue 数: 約 350 件の解決済み、約 21 件の未解決<li>トレンド: 安定しており、学術コミュニティからの継続的な更新が行われています。</ul></td>
</tr>
<tr>
	<td>コミュニティ サポート</td>
...
<tr>
	<td>人気</td>
	<td><ul><li>GitHub スター: 約 2,000 スター （2024 年 12 月現在）<li>GitHub フォーク: 約 384 フォーク<li>Issue 数: 約 79 件の解決済み、 約 63 件の未解決<li>トレンド: 敵対的堅牢性のための継続的なアップデートと業界での採用により、着実に成長しています。</ul></td>
</tr>
<tr>
	<td>コミュニティ サポート</td>
...
<tr>
	<td>人気</td>
	<td><ul><li>GitHub スター: 約 3,500 スター （2024 年 12 月現在）<li>GitHub フォーク: 約 303 フォーク<li>Issue 数: 約 299 件の解決済み、約 303 件の未解決<li>トレンド: 特に攻撃生成と LLM 脆弱性スキャンにおいて成長しています。</ul></td>
</tr>
<tr>
	<td>コミュニティ サポート</td>
...
<tr>
	<td>人気</td>
	<td><ul><li>GitHub スター: 約 427 スター （2024 年 12 月現在）<li>GitHub フォーク: 約 56 フォーク<li>Issue 数: 6 件の解決済み、約 10 件の未解決<li>トレンド: 2024 年 8 月以降更新なし。</ul></td>
</tr>
<tr>
	<td>コミュニティ サポート</td>
...
<tr>
	<td>人気</td>
	<td><ul><li>GitHub スター: 約 4,300 スター （2024 年現在）<li>GitHub フォーク: 約 326 フォーク<li>Issue 数: 約 296 件の解決済み、40 件の未解決<li>トレンド: 一貫性とタイムリーなアップデートにより着実に成長しています。</ul></td>
</tr>
<tr>
	<td>コミュニティ サポート</td>
...
<tr>
	<td>GitHub リンク</td>
	<td><a href=”https://github.com/promptfoo/promptfoo">https://github.com/promptfoo/promptfoo</a></td>
</tr>
	<tr>
	<td>言語</td>
	<td>Python、NodeJS</td>
...
<tr>
	<td>ライセンス</td>
	<td>MIT ライセンス下のオープン ソース<ul><li>メイン コードベースは MIT ライセンス。<li>/src/redteam/ ディレクトリは独自のものであり、Promptfoo Enterprise License に基づいてライセンス。<li>一部のサードパーティ コンポーネントは独自のライセンス（それぞれのディレクトリ内の LICENSE ファイルに示されています）。</ul></td>
</tr>
<tr>
	<td>軽減策の提供</td>
	<td>防止: あり、検出: あり</td>
...
<tr>
	<td>人気</td>
	<td><ul><li>GitHub スター: 約 4,300 スター （2024 年現在）<li>GitHub フォーク: 約 320 フォーク<li>Issue 数: 約 523 件の解決済み、108 件の未解決<li>トレンド: 一貫性したアップデート。</ul></td>
</tr>
<tr>
	<td>コミュニティ サポート</td>
	<td><ul><li>アクティブな問題: 問題は数日以内に解決されます。<li>文書化: ユーザーガイドを含む詳細な文書が用意されています。<li>ディスカッション フォーラム: 主アクティブな Github の Issueと Discord でのサポートも利用可能。<li>貢献者: 113 名以上の貢献者。</ul></td>
</tr>
<tr>
	<td>スケーラビリティ</td>
	<td><ul><li>フレームワーク サポート: 言語: Javascript<li>大規模なデプロイメント: クラウドへのデプロイメントをサポートするエンタープライズ バージョンが利用可能です。</ul></td>
</tr>
<tr>
	<td>統合</td>
	<td><ul><li>互換性: ほとんどの LLM と互換性があります。</ul></td>
...
このセクションでは、説明されているツールを、人気、コミュニティ サポート、スケーラビリティ、統合の観点から評価します。

![testtoolrating.png](./assets/testtoolrating.png)

| 属性 | 高 | 中 | 低 |
| ----- | ----- | ----- | ----- |
| 人気 | > 3,000 スター | 1,000～3,000 スター| < 1,000 スター|
| コミュニティ サポート | > 100 貢献者、迅速な対応（< 3 日）| 50～100 貢献者、3～14 日以内での対応 | < 50 貢献者、遅い対応（> 14 日） |
| スケーラビリティ | 実績のあるエンタープライズ グレード、マルチ フレームワーク | 中程度のスケーラビリティ、限られたフレームワーク | 研究に重点を置いた小規模 |
| 統合 | 幅広い互換性 | 互換性が限られており、使用事例が狭い | 統合は最小限または全くなく、研究ツールのみ |

評価の利用に関する免責事項:

<i><b>
- 評価の範囲: 本レビューはオープン ソースのレッド チム演習用のツールのみを対象としています。独自仕様または商用ソリューションは本評価に含まれていません。
- 独立レビュー: 本評価は独立したものであり、GitHub リポジトリ、公式文書、関連コミュニティの議論など、公開されている情報のみに基づいています。
- ツールのバージョンと関連性: 本評価で提供される情報と推奨事項は、2024 年 9 月時点のものです。これらのツールの今後のアップデート、機能強化、または変更については、提供されているリンクまたはそれぞれの情報源から直接確認し、関連性を確保してください。
</b></i>

**ツールの適合性と使用方法:**

*本レポートの推奨事項は、組織の具体的な使用事例、規模、セキュリティ態勢に基づいて検討する必要があります。一部のツールは、小規模なプロジェクトや環境には必要のない高度な機能を備えている場合もあれば、特定のフレームワークやセキュリティ目標に適したツールもあります。*
